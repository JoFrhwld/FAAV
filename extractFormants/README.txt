...
measureUnstressed	If false, then vowels marked with 0 stress in the pronouncing dictionary are not measured.  If truen, then all vowels are measured.
...
outputFormat		If 'text', then the vowel formant measurements are output to a tab-delimited file.  If 'plotnik', then the output is a Plotnik file.  See Section V for details about interpreting the contents of these files.
